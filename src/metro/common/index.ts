...
import { findByFilePathLazy, findByPropsLazy } from '../wrappers';
...
// React
export const React = (window.React = findByPropsLazy(
  'createElement'
) as typeof import('react'));
export const ReactNative = (window.ReactNative = findByPropsLazy(
  'AppRegistry'
